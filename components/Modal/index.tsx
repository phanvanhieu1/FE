...
const Modal = ({ show, onCloseModal, children }: any) => {
  const onClose = () => {
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:p-6">
                <div className="absolute top-0 right-0 p-3 z-[999]">
                  <button
                    type="button"
                    className="pg-modal-close-btn bg-white rounded-md text-gray-400 hover:text-red-500 focus:outline-none"
                    onClick={onClose}
                  >
                    <AiOutlineClose />
                  </button>
